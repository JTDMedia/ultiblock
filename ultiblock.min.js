let hiddenBody=!1,imagesCdnUrl="https://raw.githubusercontent.com/JTDMedia/potatoshield/refs/heads/main/assets",body=document.querySelector("body");async function detectAdBlock(){let n=!1;try{var e=await fetch(new Request("https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js")),o=(e.headers.get("content-length")||(n=!0),(await fetch(new Request("https://www.googletagservices.com/tag/js/gpt.js"))).headers.get("content-length")||(n=!0),["uBlock","height:1px!important"]);let t=await e.text();o.some(e=>t.includes(e))&&(n=!0);var i=document.createElement("div"),a=(i.id="ad-test",i.style.display="none",document.body.appendChild(i),document.getElementById("ad-test")||(n=!0),document.createElement("div"));a.className="adsbygoogle",a.style.width="1px",a.style.height="1px",document.body.appendChild(a),0===a.offsetHeight&&(n=!0),document.body.removeChild(a)}catch(e){console.error(e),n=!0}finally{console.log("AdBlock Enabled: "+n)}return n}function hideBody(){body.setAttribute("aria-hidden","true"),hiddenBody&&(body.innerHTML="")}function showBannerAdBlock(){body.style.setProperty("overflow","hidden","important"),body.innerHTML+=getBannerAdBlockHTML();var e=document.createElement("script");e.textContent=`
  ...
  `}function getHowDisableButton(){return"How to disable?"}function getReturnBackButton(){return"Back"}window.onload=async()=>{await detectAdBlock()&&(hideBody(),showBannerAdBlock())};